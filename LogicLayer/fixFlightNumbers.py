...
def fixFlNo(flights, destinations):
    ...
    #hvern dag numer hvad i rodinni thann daginn thetta flug er
        ...
        for k in range(len(flightsFromDest_i)):
            ...
            day = str(flightsFromDest_i[k].departure[0:10]) + 'T00:00:00'
